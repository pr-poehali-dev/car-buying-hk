...
function Index({ city: cityProp }: IndexProps = {}) {
  ...
  return (
    <div className="min-h-screen bg-background font-open-sans">
                ...
                <CardContent className="p-0 space-y-3 sm:space-y-4">
                  <div className="text-center">
                    <h3 className="font-bold text-lg sm:text-xl text-gray-900 mb-1 sm:mb-2">
                      ⚡ Оценка за 30 секунд — БЕСПЛАТНО
                    </h3>
                    <p className="text-xs sm:text-sm text-gray-600">Оставьте телефон → Перезвоним за 30 сек → Назовём точную цену</p>
                  </div>
      ...
      {/* Social Proof Banner */}
      <section className="py-6 md:py-8 bg-gradient-to-r from-green-50 to-blue-50 border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6">
            <Badge className="bg-green-600 text-white px-4 py-2 text-sm font-semibold">
              ✅ Официально работаем с 2015 года • Все отзывы реальные
            </Badge>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            <div className="text-center bg-white rounded-lg p-4 shadow-sm">
              <div className="flex items-center justify-center mb-2">
                ...
                <div className="text-2xl md:text-4xl font-bold text-primary">2847</div>
              </div>
              <div className="text-xs md:text-sm text-gray-600 font-medium">Выкупленных авто</div>
              <div className="text-xs text-green-600 mt-1">+3 сегодня</div>
            </div>
            <div className="text-center bg-white rounded-lg p-4 shadow-sm">
              <div className="flex items-center justify-center mb-2">
                <Icon name="Star" className="w-6 h-6 md:w-8 md:h-8 text-yellow-400 mr-2 fill-yellow-400" />
                <div className="text-2xl md:text-4xl font-bold text-primary">4.8</div>
              </div>
              <div className="text-xs md:text-sm text-gray-600 font-medium">Рейтинг на Яндекс</div>
              <div className="text-xs text-gray-500 mt-1">127 отзывов</div>
            </div>
            <div className="text-center bg-white rounded-lg p-4 shadow-sm">
              <div className="flex items-center justify-center mb-2">
                <Icon name="TrendingUp" className="w-6 h-6 md:w-8 md:h-8 text-primary mr-2" />
                <div className="text-2xl md:text-4xl font-bold text-primary">+15%</div>
              </div>
              <div className="text-xs md:text-sm text-gray-600 font-medium">Дороже конкурентов</div>
              <div className="text-xs text-green-600 mt-1">Проверено!</div>
            </div>
            <div className="text-center bg-white rounded-lg p-4 shadow-sm">
              <div className="flex items-center justify-center mb-2">
              ...
              <div className="text-xs md:text-sm text-gray-600 font-medium">Скрытых платежей</div>
              <div className="text-xs text-green-600 mt-1">Гарантия</div>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
            ...
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm">
              ...
              <span className="text-sm font-medium text-gray-700">Лицензированная компания</span>
            </div>
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm">
              <Icon name="ThumbsUp" className="w-5 h-5 text-green-600" />
              <span className="text-sm font-medium text-gray-700">98% повторных обращений</span>
            </div>
          </div>
        </div>
      </section>
